#!/usr/bin/python3
# for local development, just "python3 aquatint.py"

# WSGIScriptAlias /aquatint is this Python code, so
# URLs are rooted there.
...
scratch = "/disk/0/www/tmp/aquatint"
...
aq_Proc = "/disk/0/www/support/ljg/bin/aquatint"
